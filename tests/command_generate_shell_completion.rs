    ...
    assert
        ...
        .stderr(indoc! {"
            \u{1b}[1m\u{1b}[31merror:\u{1b}[0m invalid value \'\u{1b}[33mfoo\u{1b}[0m\' for \'\u{1b}[1m<SHELL>\u{1b}[0m\'
              [possible values: \u{1b}[32mbash\u{1b}[0m, \u{1b}[32melvish\u{1b}[0m, \u{1b}[32mfish\u{1b}[0m, \u{1b}[32mpowershell\u{1b}[0m, \u{1b}[32mzsh\u{1b}[0m, \u{1b}[32mnushell\u{1b}[0m, \u{1b}[32mfig\u{1b}[0m]
